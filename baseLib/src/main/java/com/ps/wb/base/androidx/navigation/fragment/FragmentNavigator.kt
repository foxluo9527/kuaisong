package com.ps.wb.base.androidx.navigation.fragment
...
import com.ps.wb.base.androidx.navigation.fragment.FragmentNavigator.Destination
import java.util.*
...
class FragmentNavigator(
    ...
    private fun getDestId(backStackName: String): Int {
        ...
        val split: Array<String> =
            (backStackName?.split("-") ?: arrayOfNulls<String>(0)) as Array<String> // KT版本
